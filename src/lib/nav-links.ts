...
export const adminNavLinks: NavLink[] = [
	...
	},
	{
		...
		submenu: [
			...
			{
				key: 'MASTER_DATA_ATTACHMENTS',
				href: '/admin/master-data/attachments',
				label: 'Attachments',
				icon: Paperclip,
			},
			...
			},
			{
				...
				submenu: [
					...
					{
						key: 'MASTER_DATA_OUTSOURCING_ZONE',
						href: '/admin/master-data/outsourcing/outsourcing-zone',
						label: 'Zone',
					},
					{
...
export const jobseekerNavLinks: NavLink[] = [
	...
	},
	{
		...
		submenu: [
			...
			{
				key: 'PROFILE_EDIT_TRAINING',
				href: '/jobseeker/profile-edit/training',
				label: 'Training',
				icon: BookCopy,
			},
			{

        ...
        {isLoading ? (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              {(user.roles.includes(ROLES.ADMIN) || user.roles.includes(ROLES.SUPER_ADMIN) || user.roles.includes(ROLES.OPERATOR)) && !pathname.startsWith('/admin') && !pathname.startsWith('/dashboard') && (
